...
@section('content')
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Edit Skill: {{ $skill->name }}</h1>
        ...
        <form action="{{ route('admin.skills.update', $skill) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="name" id="name" class="form-input mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('name', $skill->name) }}" required>
                ...
                <div>
                    ...
                    <select name="category" id="category" class="form-select mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                        ...
                        <option value="Tools & DevOps" {{ old('category', $skill->category) == 'Tools & DevOps' ? 'selected' : '' }}>Tools & DevOps</option>
                ...
                <div>
                    ...
                    <input type="text" name="icon_class" id="icon_class" class="form-input mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('icon_class', $skill->icon_class) }}" placeholder="Font Awesome class">
                ...
                <div>
                    ...
                    <input type="number" name="order" id="order" class="form-input mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('order', $skill->order) }}" required>
